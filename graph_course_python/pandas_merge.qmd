...
tb_2019_africa = pd.read_csv(
    "data/tb_africa_2019.csv") 

# Health expenditure data
health_exp_2019 = pd.read_csv(
    "data/health_exp_2019.csv")
...
tb_cases_children = pd.read_csv(
    "data/tb_cases_children.csv").dropna()

# Country continents data
country_continents = pd.read_csv(
    "data/country_continents.csv")
...
```{python}
tb_child_continent_joined = pd.merge(tb_cases_children, country_continents, left_on = "country", right_on = "country name", how = "left")
tb_child_continent_joined
```
